"""Script to extract text from images using RetinaNet."""
...
from api.utils.inference import read_image_from_path


class BaseFaceRecognition(ABC):
    """Base class for Face models."""
    ...
    def visualize(self, impath: Path | str, save_path: Path | str | None = None) -> np.ndarray:
        ...
        img = read_image_from_path(impath)
...
class RetinaNetWrapper(BaseFaceRecognition):
    """Wrapper class for RetinaNet."""

    def __init__(self) -> None:
        """Initialize RetinaNetWrapper."""
